...
public class cc2 {
    ...
    public void setup()
    {
        ExtentSparkReporter sparkReporter = new ExtentSparkReporter("D:\\Selenium Testing\\CC2\\Report\\report.html");
    ...
    {
        PropertyConfigurator.configure("D:\\Selenium Testing\\CC2\\CC2\\demo\\src\\test\\java\\com\\example\\log4j2.properties");
    ...
    {  
        FileInputStream fs=new FileInputStream("D:\\Selenium Testing\\CC2\\data.xlsx"); 
    ...
    public void tearDown(ITestResult result)throws Exception
    {
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String screenShotPath =  "D:\\Selenium Testing\\CC2\\Screenshots\\"+result.getName()+".png";
